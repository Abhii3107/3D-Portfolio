...
export const webProject = [
  {
    name: "TravelHost",
    description:
      "TravelHost – Built a full-stack Airbnb-style rental platform with secure user authentication, property listings, image uploads, and interactive maps, using Node.js, Express, MongoDB, and EJS with a clean MVC structure and responsive UI.",
    tags: [
      {
        name: "Node.js",
        color: "blue-text-gradient",
    ...
    image: home, // Replace with a screenshot of your portfolio
    source_link: "https://travelhost-yc0y.onrender.com/",
    source_code_link: "https://github.com/Abhii3107/TravelHost",
  },
  {
    name: "QuickDoc",
    description:
      "QuickDoc – A modern, responsive doctor appointment booking platform built with React and Tailwind CSS, featuring multi-page navigation using React Router and deployed on Vercel for optimal performance.",
    tags: [
      {
        name: "React",
        color: "green-text-gradient",
  ...
  },
  {
    ...
    image: port_3d,
    source_link: "https://3-d-portfolio-tan-nu.vercel.app/",
    source_code_link: "https://github.com/Abhii3107/3d-react-Portfolio",
  },
...
const experiences = [
  {
    ...
    company_name: "QMANSYS INFOSOLUTIONS LLP",
    icon: qmansys,
    iconBg: "#383E56",
    date: "April 2023 - June 2023",
    link: "",
    points: [
      "Collaborated with a team to create a Smart Plant Monitoring System.",
      "Designed and implemented a monitoring solution using IoT sensors to track soil moisture and temperature.",
      "Utilized AWS cloud services for storing, analyzing, and visualizing real-time plant health data.",
      "Built a responsive web application using React to display sensor data and provide real-time alerts for users.",
    ],
    link: "https://drive.google.com/file/d/1Fhsdsp9Pn4-tE8UtfpgB7QvJoAsxBH-z/view",
  },
